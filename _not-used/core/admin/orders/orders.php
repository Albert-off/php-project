...
// Getting all ACTIVE orders from DB.
$activeOrders = getAllActiveOrders();


// --======== DATA PAGINATION ========-- 
// 1. Total count of ACTIVE orders.
...
$currentOrders = array_slice($activeOrders, $offset, $ordersPerPage);
                ...
                <section class="table__body">
                    <table>
                        ...
                        <tbody>
                            ...
                            <?php 
                                // $index = 1;  // Using offset + 1 value for correct pagination index.
                                $index = $offset + 1;
                                ...
                                <tr id="order-<?= $order['id'] ?>">
                                    ...
                                    <td><button onclick="archiveSelectedOrder(<?= $order['id'] ?>)" class="arc-btn">Archive</button></td>
